...
import compilador.semantico.Compilador;
import compilador.View.Editor;
import compilador.semantico.Sintatico;
...
public class ControleEditor implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        } catch (ErroSintatico|ErroSemantico ex) {

        }
    }

    public void verificarComando(ActionEvent ae) throws IOException, ErroSintatico, ErroSemantico {
